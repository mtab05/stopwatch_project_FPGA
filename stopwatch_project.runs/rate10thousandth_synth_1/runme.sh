...
HD_PWD='W:/Desktop/ELEC 3500 LABS/stopwatch_project/stopwatch_project.runs/rate10thousandth_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rate10thousandth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rate10thousandth.tcl
