...
HD_PWD='W:/Desktop/ELEC 3500 LABS/lab9_3_1/lab9_3_1.runs/refreshrate_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log refreshrate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source refreshrate.tcl
