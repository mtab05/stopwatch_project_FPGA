...
HD_PWD='W:/Desktop/ELEC 3500 LABS/stopwatch_project/stopwatch_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_stopwatch_project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_stopwatch_project.tcl -notrace
