...
HD_PWD='W:/Desktop/ELEC 3500 LABS/stopwatch_project/stopwatch_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_stopwatch_project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_stopwatch_project.tcl
